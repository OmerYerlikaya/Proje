      ...
      <div class="card o-hidden border-0 shadow-md" style="min-width: 45%">
       <div class="p-5">
        <div class="text-center">
          <h2 class="h2 text-gray-900 mb-4">Bilgisayar Programcılığı</h2>
        </div>
        <form class="user" action="islemler/islem.php" method="POST">
          <div class="form-group">
            <input name="kul_mail" required type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" autocomplete="off" placeholder=" E-Mail ">
          </div>
          <div class="form-group">
		  ...
		  <center><div class="g-recaptcha" data-sitekey="6Lfr8t4aAAAAAByG7xsIHgipOYdoEJJ3EE3_T_r1"></div></center></br>
...
<?php if (@$_GET['durum']=="captcha")  {?>  
  <script>
    Swal.fire({
      type: 'error',
      title: 'Robot ??',
      text: 'Lütfen Ben Robot Değilim bölümünü işaretleyin.',
      showConfirmButton: true,
      confirmButtonText: 'Kapat'
    })
  </script>
